                ...
                <div className="mt-8">
                    <aside className="bg-black text-white p-6 rounded-lg w-full max-w-lg font-mono dark:bg-slate-100 ">
                        ...
                        <div className="mt-4">
                            ...
                            <p className="text-red-500  dark:text-red-600 ">× ./src/blog/page.js Error: </p>
                            <p className="text-white dark:text-slate-800 ">Bahh j'ai la flèmme mais t'inquiète le blog arrive très vite 🤣 </p>
